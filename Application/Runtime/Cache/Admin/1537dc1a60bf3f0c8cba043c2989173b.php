                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
									...
									<td><?php echo ($vo['proPath']); ?></td>
                                    <td>
                                    <?php if($vo['proLive'] == 1): ?>可用
                                        <?php else: ?>
                                        不可用<?php endif; ?>
                                    </td>
									<td><a style="color:black;padding-left:5px;padding-right:5px;" href='<?php echo U('Cate/update','cateid='.$vo['proPid'].'&id='.$vo['proTypeId']);?>'>修改</a> | 
                                    <?php if($vo['proLive'] == 1): ?><a style="color:black;padding-left:5px;padding-right:5px;" href='<?php echo U('Cate/delete_doit','cateid='.$vo['proTypeId']);?>' onclick="javascript:return confirm('确定要删除么');">禁用</a>
                                        <?php else: ?>
                                        <a style="color:black;padding-left:5px;padding-right:5px;" href='<?php echo U('Cate/active_doit','cateid='.$vo['proTypeId']);?>' onclick="javascript:return confirm('确定要启用么');">启用</a><?php endif; ?>
                                     | <a style="color:black;padding-left:5px;padding-right:5px;" href="<?php echo U('Cate/add','cateid='.$vo['proTypeId']);?>">增加子类</a></td>
