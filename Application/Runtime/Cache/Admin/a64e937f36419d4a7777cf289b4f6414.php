                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <!--循环输出订单-->
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                    <!--判断订单状态-->
                                        <?php switch($vo["orderState"]): case "0": ?><a href="<?php echo U('Order/orderUpdate',array('orderId'=>$vo['orderId'],'orderState'=>1));?>"><button type="button" class="btn btn-danger">开始发货</button></a><?php break;?>
                                            <?php case "1": ?><font color="red">等待收货</font><?php break;?>
                                            <?php case "2": ?><font color="green">交易完成</font><?php break;?>
                                            <?php default: ?><font color="red">订单已取消</font></case><?php endswitch;?>
                                    </td>
                                    <td><a href="<?php echo U('Order/detail','orderId='.$vo['orderId']);?>"><button type="button" class="btn btn-success btn-small">订单详情</button></a></td>
                                    <td>
                                        <?php if($vo['orderState'] == 0): ?><a href="<?php echo U('Order/updateOrder','orderId='.$vo['orderId']);?>"><button type="button" class="btn">修改</button></a>
                                        
                                             <a href="<?php echo U('Order/orderUpdate',array('orderId'=>$vo['orderId'],'orderState'=>3));?>"><button type="button" class="btn">取消订单</button></a>
                                        <?php elseif($vo['orderState'] == 3): ?>
                                            <font color="red">订单已取消，禁止修改</font>
                                        <?php elseif($vo['orderState'] == 2): ?>
                                            <font color="green">订单交易完成</font>
                                        <?php else: ?>
                                            <font color="red">已发货，禁止修改</font><?php endif; ?>
                                    </td>
