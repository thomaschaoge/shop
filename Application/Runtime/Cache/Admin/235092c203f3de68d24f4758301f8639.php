            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="<?php echo U('Window/do_add');?>" 
                              method="post">
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                                        ...
                                        type="text" disabled
                                        value="<?php echo ($data["indexCC"]); ?>" 
                                        class="large">
                                        <input type="hidden" value='<?php echo ($data["indexCCId"]); ?>'name="indexCCPid"class="large">
                    				</div>
                    			</div>
                                <div class="mws-form-row">
                                    <label class="mws-form-label">导航栏名称</label>
                                    <div class="mws-form-item">
                                        <input type="text" name="indexCC"class="large">
                                    </div>
                                </div>
                                ...
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <textarea rows="" cols="" class="large" name="indexCCDWZ"></textarea>
                                    </div>
                                </div>
                    		</div>
