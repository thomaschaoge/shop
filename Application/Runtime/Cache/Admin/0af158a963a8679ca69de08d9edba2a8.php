            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8 mws-collapsible">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> 浏览图片</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                    <form action="<?php echo U('Multipics/index');?>" method="get">
                    <div class="dataTables_filter"><label>商品ID&nbsp;&nbsp;<input type="text" name="prodId" placeholder="按商品ID搜索" aria-controls="DataTables_Table_0" value="<?php echo ($_GET['prodId']); ?>"><input type="submit" class='btn' value="搜索"><a href="<?php echo U('Multipics/index');?>" class='btn'>清空</a></div>
                    </form>
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody>
                            	<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
									<td><?php echo ($vo['picId']); ?></td>
									<td><?php echo ($vo['prodId']); ?></td>
                                    <td><?php echo ($colorArr[$vo['colorId']]); ?></td>
									<td>
                                    <?php if(is_null($vo['image']) != true): ?><img src="/jd/Public/Uploads/<?php echo ($vo['image']); ?>" width="50" height="50" />
                                    <?php else: ?>暂无<?php endif; ?>
                                    </td>
                                    <td><a href="<?php echo U('Multipics/delete','cid='.$vo['picId']);?>" style="padding:0 5px" onclick="return confirm('确定要删除该图片吗？')">删除</a></td>
