...
<div id="mws-header" class="clearfix">
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>首页橱窗导航栏表</span>
                    </div>
                        ...
                        <table class="mws-datatable-fn mws-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>橱窗导航栏父级编号</th>
                                    <th>网站地址</th>
                                    <th style="text-align:left" name="add"><a href="<?php echo U("add");?>"><button class="btn btn-primary" type="button"><b>父级添加</b></button></a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if(is_array($data)): foreach($data as $key=>$val): ?><tr>
                                        <td><?php echo ($val["indexCCId"]); ?></td>
                                        <td><?php echo ($val["indexCC"]); ?></td>
                                        <td><?php echo ($val["indexCCPid"]); ?></td>
                                        <td><?php echo ($val["indexCCDWZ"]); ?></td>
                                        <td>
                                            <a class="btn btn-small" href='<?php echo U("edit",array('indexCCId'=>$val['indexCCId']));?>'>
                                            <i class="icon-pencil"></i>
                                            </a>
                                            <a class="btn btn-small" 
                                            href='<?php  if($val['indexCCPid']==0){ echo U('add',array('indexCCId'=>$val['indexCCId'])); }else{ echo "javascript:void(0);"; } ?>'>
                                            <i class="<?php echo ($val['indexCCPid']==0)?'icon-plus':'icon-ban-circle'?>"></i>
                                            </a>
                                            <a class="btn btn-small"
                                            name='delete'
                                            value='<?php echo ($val["indexCCId"]); ?>'>
                                            <i class="icon-trash">
                                            </i>
                                            </a>
                                        </td>
                ...
                <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i>&nbsp;橱窗大类别表
                              <i style="cursor: pointer;margin-left:85%;margin-top:5px;"class='icol-application-get'></i>
                        </span>
                    </div>
                    <div class="mws-panel-body no-padding" style="display:block;">
                    <table class="mws-datatable-fn mws-table">
                            <thead>
                                <tr>
                                    <th>橱窗大类别表编号</th>
                                    <th>橱窗大类别表分类路径</th>
                                    <th>橱窗导航栏浮级编号</th>
                                    <th style="text-align:center" name="add"><a href="<?php echo U("ccadd");?>"><button class="btn btn-primary" type="button"><b>添加</b></button></a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if(is_array($datacc)): foreach($datacc as $key=>$val): ?><tr>
                                        <td><?php echo ($val["cctptypeId"]); ?></td>
                                        <td><?php echo ($val["cctptypeName"]); ?></td>
                                        <td><?php echo ($val["indexCCId"]); ?></td>
                                        <td style="text-align:center;">
                                            <a class="btn btn-small" href='<?php echo U("ccedit",array('cctptypeId'=>$val['cctptypeId']));?>'>
                                            <i class="icon-pencil"></i>
                                            </a>
                                            <a class="btn btn-small"
                                            name='ccdelete'
                                            value='<?php echo ($val["cctptypeId"]); ?>'>
                                            <i class="icon-trash">
                                            </i>
                                            </a>
                                        </td>
    ...
    <script src="/jd/Application/Admin/Common/Js//visi_control.js"></script>-->
    <!-- 橱窗导航的页面的JS效果 -->
    <script src="/jd/Application/Admin/Common/Js//index_action.js"></script>
</body>
</html>