            ...
            <div class="container">
                ...
                <div class="mws-panel grid_4">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="<?php echo U('Cate/update_doit');?>" method="post" id="category">					
							<div class="mws-form-inline">
								<div class="mws-form-row bordered">
	                                    <label class="mws-form-label">父级分类</label>
	                                    <div class="mws-form-item">
	                                        <select class="small" name="proPid" id="pid" disabled="disabled">
	                                            <?php echo ($options); ?>
	                                        </select>
	                                    </div>
	                            </div>
                            ...
                            <div class="mws-form-inline">
                                <div class="mws-form-row bordered">
                                    ...
                                    <div class="mws-form-item">
                                        <input type="text" class="large" name="proName" value="<?php echo ($val['proName']); ?>" id="val">
                                        <input type="hidden" name="proTypeId" value="<?php echo ($val['proTypeId']); ?>">
                                    </div>
                                </div>
                            </div>
