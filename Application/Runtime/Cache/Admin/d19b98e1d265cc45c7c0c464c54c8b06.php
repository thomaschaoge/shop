            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8 mws-collapsible">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> 浏览品牌</span>
                    </div>
                        ...
                        <table class="mws-table mws-datatable">
                            ...
                            <tbody>
                            	<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
									<td><?php echo ($vo['brandId']); ?></td>
									<td><?php echo ($vo['brandName']); ?></td>
                                    <td><a href="<?php echo U('Brands/delete','brandId='.$vo['brandId']);?>" style="padding:0 5px" onclick="return confirm('确定要删除该品牌吗？')">删除</a> | <a href="<?php echo U('Brands/edit','brandId='.$vo['brandId']);?>" style="padding:0 5px">修改</a></td>
