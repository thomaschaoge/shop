            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>用户调查表</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <?php if(is_array($surveyData)): foreach($surveyData as $key=>$val): ?><tr>
                                        <td><?php echo ($val["sId"]); ?></td>
                                        <td><?php echo ($val["myd"]); ?></td>
                                        <td><?php echo ($val["suggest"]); ?></td>
                                        <td><?php echo ($val["sex"]); ?></td>
                                        <td><?php echo ($val["age"]); ?></td>
                                        <td><?php echo ($val["learn"]); ?></td>
                                        <td><?php echo ($val["work"]); ?></td>
                                        <td><?php echo ($val["province"]); ?></td>
                                        <td><a href="<?php echo U('Survey/delete',array('sId'=>$val['sId']));?>">
