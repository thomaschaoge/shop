            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icol32-newspaper"></i>新闻信息</span>
                    </div>
                        ...
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <?php if(is_array($arr)): foreach($arr as $key=>$vo): ?><tr>
                                    ...
                                    <td><?php echo ($vo["newsInfo"]); ?></td>
                                    <td><?php echo ($vo['is_checked'] == 0?'已审核':'未审核'); ?></td>
                                    <td><?php echo ($vo['is_show'] == 1?'显示':'不显示'); ?></td>
                                    <td><?php
 if($vo['activity'] == 0){ echo "优惠促销"; }else if($vo['activity'] == 1){ echo "限时抢购"; }else{ echo '推广商品'; } ?></td>
                                    <td width="120px">
                                        <a href="<?php echo U('News/editNews',array('newsId'=>$vo['newsId']));?>"><button type="button" class="btn" >修改</button></a>
                                        <a href="<?php echo U('News/DelNews',array('newsId'=>$vo['newsId']));?>"><button type="button" class="btn" >删除</button></a>
                                    </td>
