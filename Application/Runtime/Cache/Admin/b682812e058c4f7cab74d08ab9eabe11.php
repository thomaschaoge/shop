...
<title>JD Admin - 管理员系统</title>
<script>
        /*var adminId='<?php session_start();echo $_SESSION['adminId'] ?>'; 
        var levelId='<?php session_start();echo $_SESSION['levelId'] ?>'; */
</script>
</head>
...
<div id="mws-header" class="clearfix">
            ...
            <div class="container">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>权限管理员表</span>
                    </div>
                            ...
                            <thead>
                                <tr>
                                   ...
                                   <!--  <th>帐号密码</th> -->
                                    <th>管理员昵称</th>
                                    <th>角色编号</th>
                                    <th style="text-align:left" name="add"><a href="<?php echo U("register");?>"><button class="btn btn-primary" type="button"><b>添加</b></button></a></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if(is_array($gdatalist)): foreach($gdatalist as $key=>$val): ?><tr>
                                        <td><?php echo ($val["adminId"]); ?></td>
                                        <td><?php echo ($val["uname"]); ?></td>
                                        <!-- <td><?php echo ($val["upwd"]); ?></td> -->
                                        <td><?php echo ($val["nickName"]); ?></td>
                                        <td><?php echo ($levelname[$val['levelId']]); ?></td>
                                        <td>
                                            <a class="btn btn-small" href='<?php echo U("gaEdit",array('adminId'=>$val['adminId']));?>'>
                                            <i class="icon-pencil"></i>
                                            </a>
                                            <a  name='gisdeleted'
                                                value='<?php echo ($val["adminId"]); ?>'
                                                class="btn btn-small"
                                            href="javascript:void(0)">
                                            <i value='<?php echo ($val["isdeleted"]); ?>'
                                            class="<?php echo $val['isdeleted']?'icon-lock':'icon-unlock'; ?>
                                            "></i>
                                            </a>
                                            <a class="btn btn-small"
                                                name='delete'
                                                value='<?php echo ($val["levelId"]); ?>'>
                                                <i class="<?php echo ($val['levelId']!=1)?'icon-trash':'icon-thumbs-up'?>">
                                                </i>
                                            </a>
                                        </td>
                ...
                <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i>&nbsp;权限表
                              <i style="cursor: pointer;margin-left:91%;margin-top:5px;"class='icol-application-put'></i>
                        </span>
                    </div>
                    <div class="mws-panel-body no-padding" style="display:none;">
                        <table class="mws-datatable-fn mws-table">
                            <thead>
                                <tr>
                                    <th>权限编号</th>
                            ...
                            <tbody>
                                <?php if(is_array($pdatalist)): foreach($pdatalist as $key=>$val): ?><tr>
                                        <td><?php echo ($val["powerId"]); ?></td>
                ...
                <div class="mws-panel grid_8">
                    <div class="mws-panel-header">
                        <span><i class="icon-table"></i>&nbsp;&nbsp;角色权限表
                              <i style="cursor: pointer;margin-left:88%;margin-top:5px;"class='icol-application-put'></i>
                        </span>
                    </div>
                    <div class="mws-panel-body no-padding" style="display:none">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <?php if(is_array($rdatalist)): foreach($rdatalist as $key=>$val): ?><tr>
                                        <td><?php echo ($val["relationId"]); ?></td>
                                        <td><?php echo ($levelname[$val['levelId']]); ?></td>
                                        <td><?php echo ($val["powerId"]); ?></td>
                                    </tr><?php endforeach; endif; ?>
                            </tbody>
                ...
                <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding" style="display:none">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                                <?php if(is_array($ldatalist)): foreach($ldatalist as $key=>$val): ?><tr>
                                        <td><?php echo ($val["levelId"]); ?></td>
                                        <td><?php echo ($val["levelName"]); ?></td>
                                    </tr><?php endforeach; endif; ?>
                            </tbody>
                        </table>
                    </div>
    ...
    <script src="/jd/Application/Admin/Common/Js//admin_action.js"></script>
    <!--<script src="/jd/Application/Admin/Common/Js//visit_control.js"></script>-->
</body>
</html>