...
.content{ background:url('__PUBLIC__/Uploads/errorImages/success.jpg') no-repeat center; font-family: '微软雅黑'; color: #333; font-size: 16px; width:1331px;height:886px;}
<?php }else{?>
.content{ background:url('__PUBLIC__/Uploads/errorImages/error1.jpg') no-repeat center; font-family: '微软雅黑'; color: #333; font-size: 16px; 
